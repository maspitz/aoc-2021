"""Tests for day DAY_NUMBER of Advent of Code 2021."""
...
def test_part_a():
    ...
    assert dayDAY_NUMBER.part_a(sample_input_data) == sample_solution_a


def test_part_b():
    """Test the solution on sample data for part B."""
    assert dayDAY_NUMBER.part_b(sample_input_data) == sample_solution_b
